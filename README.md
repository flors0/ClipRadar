...
- Seek by clicking the normal playback timeline, which represents only the selected cut, and adjust that cut with a separate relative two-handle timeline inside a 30-second source buffer on either side.
